...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Friendship', fields ['followed', 'follower']
        db.create_unique(u'users_friendship', ['followed_id', 'follower_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Friendship', fields ['followed', 'follower']
        db.delete_unique(u'users_friendship', ['followed_id', 'follower_id'])
    ...
    models = {
        ...
        u'users.friendship': {
            'Meta': {'unique_together': "(('followed', 'follower'),)", 'object_name': 'Friendship'},
