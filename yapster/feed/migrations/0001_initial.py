...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'feed_feed', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feeds', to=orm['auth.User'])),
            ('yap', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yap.Yap'])),
            ('yap_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feeds_yap', to=orm['auth.User'])),
            ('reyap_user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='feeds_reyap', null=True, to=orm['auth.User'])),
