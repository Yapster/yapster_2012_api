...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Feed', fields ['user', 'yap', 'yap_user', 'reyap_user']
        db.create_unique(u'feed_feed', ['user_id', 'yap_id', 'yap_user_id', 'reyap_user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Feed', fields ['user', 'yap', 'yap_user', 'reyap_user']
        db.delete_unique(u'feed_feed', ['user_id', 'yap_id', 'yap_user_id', 'reyap_user_id'])
    ...
    models = {
        ...
        u'feed.feed': {
            'Meta': {'unique_together': "(('user', 'yap', 'yap_user', 'reyap_user'),)", 'object_name': 'Feed'},
